...
class ConferenceTest extends HolodeckTestCase {
    public function testFetchRequest(): void {
        ...
        try {
            $this->twilio->insights->v1->conferences("CFXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}

        $this->assertRequest(new Request(
            'get',
            'https://insights.twilio.com/v1/Conferences/CFXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
        ));
    }
    ...
    public function testFetchResponse(): void {
        ...
        $actual = $this->twilio->insights->v1->conferences("CFXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
    ...
    public function testReadRequest(): void {
        ...
        try {
            $this->twilio->insights->v1->conferences->read();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testReadFullResponse(): void {
        ...
        $actual = $this->twilio->insights->v1->conferences->read();

        $this->assertGreaterThan(0, \count($actual));
    }

    public function testReadWithRegionResponse(): void {
        $this->holodeck->mock(new Response(
            200,
            '
            {
    ...
    public function testReadWithFriendlynameStartfailureResponse(): void {
        $this->holodeck->mock(new Response(
            200,
            '
            {
    ...
    public function testReadWithDuplicateIdentityResponse(): void {
        $this->holodeck->mock(new Response(
            200,
            '
            {
    ...
    public function testReadWithDetectedIssueEndreasonResponse(): void {
        $this->holodeck->mock(new Response(
            200,
            '
            {
