...
class AccountConfigTest extends HolodeckTestCase {
    public function testReadRequest(): void {
        $this->holodeck->mock(new Response(500, ''));

        try {
            $this->twilio->microvisor->v1->accountConfigs->read();
    ...
    public function testReadEmptyResponse(): void {
        ...
        $actual = $this->twilio->microvisor->v1->accountConfigs->read();
    ...
    public function testFetchRequest(): void {
        ...
        try {
            $this->twilio->microvisor->v1->accountConfigs("key")->fetch();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testFetchResponse(): void {
        ...
        $actual = $this->twilio->microvisor->v1->accountConfigs("key")->fetch();
    ...
    public function testCreateRequest(): void {
        ...
        try {
            $this->twilio->microvisor->v1->accountConfigs->create("key", "value");
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testCreateAccountConfigResponse(): void {
        ...
        $actual = $this->twilio->microvisor->v1->accountConfigs->create("key", "value");
    ...
    public function testDeleteRequest(): void {
        ...
        try {
            $this->twilio->microvisor->v1->accountConfigs("key")->delete();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testDeleteResponse(): void {
        ...
        $actual = $this->twilio->microvisor->v1->accountConfigs("key")->delete();
