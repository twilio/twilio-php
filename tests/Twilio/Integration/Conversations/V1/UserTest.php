...
class UserTest extends HolodeckTestCase {
    public function testCreateRequest(): void {
        ...
        try {
            $this->twilio->conversations->v1->users->create("identity", $options);
    ...
    public function testCreateResponse(): void {
        ...
        $actual = $this->twilio->conversations->v1->users->create("identity");
    ...
    public function testUpdateRequest(): void {
        ...
        try {
            $this->twilio->conversations->v1->users("USXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update($options);
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testUpdateResponse(): void {
        ...
        $actual = $this->twilio->conversations->v1->users("USXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update();
    ...
    public function testDeleteRequest(): void {
        ...
        try {
            $this->twilio->conversations->v1->users("USXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->delete($options);
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testDeleteResponse(): void {
        ...
        $actual = $this->twilio->conversations->v1->users("USXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->delete();
    ...
    public function testFetchRequest(): void {
        ...
        try {
            $this->twilio->conversations->v1->users("USXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testFetchResponse(): void {
        ...
        $actual = $this->twilio->conversations->v1->users("USXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
    ...
    public function testReadRequest(): void {
        ...
        try {
            $this->twilio->conversations->v1->users->read();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testReadFullResponse(): void {
        ...
        $actual = $this->twilio->conversations->v1->users->read();
