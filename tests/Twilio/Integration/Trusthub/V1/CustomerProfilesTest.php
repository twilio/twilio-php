...
class CustomerProfilesTest extends HolodeckTestCase {
    public function testCreateRequest(): void {
        $this->holodeck->mock(new Response(500, ''));

        try {
            $this->twilio->trusthub->v1->customerProfiles->create("friendly_name", "email", "RNXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    ...
    public function testCreateResponse(): void {
        ...
        $actual = $this->twilio->trusthub->v1->customerProfiles->create("friendly_name", "email", "RNXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    ...
    public function testReadRequest(): void {
        ...
        try {
            $this->twilio->trusthub->v1->customerProfiles->read();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testReadEmptyResponse(): void {
        ...
        $actual = $this->twilio->trusthub->v1->customerProfiles->read();
    ...
    public function testFetchRequest(): void {
        ...
        try {
            $this->twilio->trusthub->v1->customerProfiles("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testFetchResponse(): void {
        ...
        $actual = $this->twilio->trusthub->v1->customerProfiles("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
    ...
    public function testUpdateRequest(): void {
        ...
        try {
            $this->twilio->trusthub->v1->customerProfiles("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testUpdateResponse(): void {
        ...
        $actual = $this->twilio->trusthub->v1->customerProfiles("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update();
    ...
    public function testDeleteRequest(): void {
        ...
        try {
            $this->twilio->trusthub->v1->customerProfiles("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->delete();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testDeleteResponse(): void {
        ...
        $actual = $this->twilio->trusthub->v1->customerProfiles("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->delete();
