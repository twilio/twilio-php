...
class CustomerProfilesEvaluationsTest extends HolodeckTestCase {
    public function testCreateRequest(): void {
        ...
        $this->assertRequest(new Request(
            'post',
            'https://trusthub.twilio.com/v1/CustomerProfiles/BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX/Evaluations',
            null,
            $values
        ));
    }
    ...
    public function testReadRequest(): void {
        ...
        try {
            $this->twilio->trusthub->v1->customerProfiles("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
                                       ->customerProfilesEvaluations->read();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testFetchRequest(): void {
        ...
        try {
            $this->twilio->trusthub->v1->customerProfiles("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
                                       ->customerProfilesEvaluations("ELXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}

        $this->assertRequest(new Request(
            'get',
            'https://trusthub.twilio.com/v1/CustomerProfiles/BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX/Evaluations/ELXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
        ));
    }
