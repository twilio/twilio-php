...
class TrunkTest extends HolodeckTestCase {
    public function testUpdateRequest(): void {
        ...
        try {
            $this->twilio->routes->v2->trunks("sip_trunk_domain")->update();
    ...
    public function testUpdateResponse(): void {
        ...
        $actual = $this->twilio->routes->v2->trunks("sip_trunk_domain")->update();
    ...
    public function testFetchRequest(): void {
        ...
        try {
            $this->twilio->routes->v2->trunks("sip_trunk_domain")->fetch();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testFetchResponse(): void {
        ...
        $actual = $this->twilio->routes->v2->trunks("sip_trunk_domain")->fetch();
