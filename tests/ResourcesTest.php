...
class MessagesTest extends PHPUnit_Framework_TestCase
{
    ...
    function testCreateMessageWithMedia() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
                'From=%2B1222&To=%2B44123&MediaUrls=http%3A%2F%2Fexample.com%2Fimage1')
            ->andReturn(array(200, array('Content-Type' => 'application/json'),
                json_encode(array('sid' => 'SM123'))
            ));
        $client = new Services_Twilio('AC123', '123', '2010-04-01', $http);
        $msg = $client->account->messages->create('+1222', '+44123',
            array('MediaUrls' => array('http://example.com/image1')));
        $this->assertSame('SM123', $msg->sid);
    }
    ...
    function testCreateMessageWithMediaAndBody() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
                'From=%2B1222&To=%2B44123&Body=Hi+there&MediaUrls=http%3A%2F%2Fexample.com%2Fimage1')
            ->andReturn(array(200, array('Content-Type' => 'application/json'),
                json_encode(array('sid' => 'SM123'))
            ));
        $client = new Services_Twilio('AC123', '123', '2010-04-01', $http);
        $msg = $client->account->messages->create('+1222', '+44123',
            array(
                'Body' => 'Hi there',
                'MediaUrls' => array('http://example.com/image1')
            ));
        $this->assertSame('SM123', $msg->sid);
    }
    ...
    function testCreateMessageWithMultipleMedia() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
                'From=%2B1222&To=%2B44123&MediaUrls=http%3A%2F%2Fexample.com%2Fimage1&MediaUrls=http%3A%2F%2Fexample.com%2Fimage2')
            ->andReturn(array(200, array('Content-Type' => 'application/json'),
                json_encode(array('sid' => 'SM123'))
            ));
        $client = new Services_Twilio('AC123', '123', '2010-04-01', $http);
        $msg = $client->account->messages->create('+1222', '+44123',
            array('MediaUrls' => array('http://example.com/image1', 'http://example.com/image2')));
        $this->assertSame('SM123', $msg->sid);
    }
