...
abstract class Services_Twilio_ConversationsListResource extends Services_Twilio_NextGenListResource {
    ...
    public function __construct($client, $uri) {
        ...
        if (!isset($this->instance_name)) {
            $this->instance_name = "Services_Twilio_Rest_Conversations_" . rtrim($name, 's');
        }
