...
class Services_Twilio_Rest_Credentials extends Services_Twilio_ListResource {
     ...
     *  .. code-block:: php
     *
     *      $client->account->sip->credential_lists->get('CLXXX')->credentials->create("AwesomeUsername" => "SuperSecretPassword", ...));
     *
