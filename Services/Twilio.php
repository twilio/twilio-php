...
{
    const USER_AGENT = 'twilio-php/4.6.0-edge';
...
/**
 * Create a client to talk to the Twilio Conversations API.
 *
 *
 * :param string               $sid:      Your Account SID
 * :param string               $token:    Your Auth Token from `your dashboard
 ...
 *
 *      require('Services/Twilio.php');
 *      $client = new Conversations_Services_Twilio('AC123', '456bef', null, null, 3);
 *      // Take some action with the client, etc.
 */
class Conversations_Services_Twilio extends Base_Services_Twilio
{
    protected $versions = array('v1');
    ...
    protected function _getBaseUri()
    {
        return 'https://conversations.twilio.com';
    }
