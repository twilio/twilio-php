...
---------------------------
**Library - Chore**
- [PR #943](https://github.com/twilio/twilio-php/pull/943): response forward compatibility test. Thanks to [@sbansla](https://github.com/sbansla)!
- [PR #941](https://github.com/twilio/twilio-php/pull/941): fix php-docs. Thanks to [@shrutiburman](https://github.com/shrutiburman)!
- [PR #937](https://github.com/twilio/twilio-php/pull/937): generated php. Thanks to [@sbansla](https://github.com/sbansla)!

**Library - Fix**
- [PR #938](https://github.com/twilio/twilio-php/pull/938): use PHP 7.4 for phpdox docs generation. Thanks to [@shrutiburman](https://github.com/shrutiburman)!
- [PR #916](https://github.com/twilio/twilio-php/pull/916): set grant type required. Thanks to [@manisha1997](https://github.com/manisha1997)!
...
---------------------------
**Library - Fix**
- [PR #914](https://github.com/twilio/twilio-php/pull/914): Php api std. Thanks to [@sbansla](https://github.com/sbansla)!

**Library - Chore**
- [PR #913](https://github.com/twilio/twilio-php/pull/913): added page details. Thanks to [@sbansla](https://github.com/sbansla)!
...
[2026-02-05] Version 8.11.0
---------------------------
**Library - Fix**
- [PR #908](https://github.com/twilio/twilio-php/pull/908): Revert "fix: Regional API domain processing". Thanks to [@shrutiburman](https://github.com/shrutiburman)!

**Library - Feature**
- [PR #902](https://github.com/twilio/twilio-php/pull/902): return response headers. Thanks to [@tiwarishubham635](https://github.com/tiwarishubham635)!
...
[2024-08-26] Version 8.2.3
--------------------------
**Library - Fix**
- [PR #812](https://github.com/twilio/twilio-php/pull/812): Orgs api metadata removal for php repo. Thanks to [@AsabuHere](https://github.com/AsabuHere)!
- [PR #781](https://github.com/twilio/twilio-php/pull/781): Eliminate typo in README.md. Thanks to [@ahmedghanem00](https://github.com/ahmedghanem00)!
...
[2024-02-27] Version 7.16.0
---------------------------
**Library - Chore**
- [PR #795](https://github.com/twilio/twilio-php/pull/795): cluster tests enabled. Thanks to [@sbansla](https://github.com/sbansla)!
...
[2024-02-09] Version 7.15.0
---------------------------
**Library - Chore**
- [PR #793](https://github.com/twilio/twilio-php/pull/793): disable cluster test. Thanks to [@sbansla](https://github.com/sbansla)!

**Library - Fix**
- [PR #792](https://github.com/twilio/twilio-php/pull/792): corrected booleanToString function. Thanks to [@tiwarishubham635](https://github.com/tiwarishubham635)!
