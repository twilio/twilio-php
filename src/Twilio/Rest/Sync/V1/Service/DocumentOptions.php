...
abstract class DocumentOptions {
    ...
    */
    public static function update(string  $ifMatch=Values::NONE,array  $data=Values::NONE,int  $ttl=Values::NONE): UpdateDocumentOptions {
        return new UpdateDocumentOptions($ifMatch,$data,$ttl);
    }
...
class UpdateDocumentOptions extends Options {
    ...
    * @param int $ttl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Sync Document expires and is deleted (time-to-live).
    */
    public function __construct(string  $ifMatch=Values::NONE,array  $data=Values::NONE,int  $ttl=Values::NONE) {
