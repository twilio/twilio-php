...
class StreamMessageList extends ListResource {
    ...
    /**
     * Constructs a StreamMessageContext
     *
     */
    public function getContext(): StreamMessageContext {
        return new StreamMessageContext($this->version, $this->solution['serviceSid'], $this->solution['streamSid']);
    }
