...
class KnowledgeBasisList extends ListResource
    {
    /**
     * Construct the KnowledgeBasisList
     *
     ...
     *
     * @param KnowledgeBaseCore $knowledgeBaseCore
     
     * @return Response Created Response
     * @throws TwilioException When an HTTP error occurs.
     */
    private function _create(KnowledgeBaseCore $knowledgeBaseCore): Response
    {
        
        $uri = '/ControlPlane/KnowledgeBases';
        
        $headers = Values::of(['Content-Type' => 'application/json', 'Accept' => 'application/json' ]);
        $data = $knowledgeBaseCore->toArray();
        return $this->version->handleRequest('POST', $uri, [], $data, $headers, "create");
    }

    /**
     * Create the CreateKnowledgeBase202ResponseInstance
     *
     * @param KnowledgeBaseCore $knowledgeBaseCore
     
     * @return CreateKnowledgeBase202ResponseInstance Created CreateKnowledgeBase202ResponseInstance
     * @throws TwilioException When an HTTP error occurs.
     */
    public function create(KnowledgeBaseCore $knowledgeBaseCore): CreateKnowledgeBase202ResponseInstance
    {
        $response = $this->_create( $knowledgeBaseCore);
        return new CreateKnowledgeBase202ResponseInstance(
            $this->version,
            $response->getContent()
        );
    ...
    /**
     * Create the CreateKnowledgeBase202ResponseInstance with Metadata
     *
     * @param KnowledgeBaseCore $knowledgeBaseCore
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function createWithMetadata(KnowledgeBaseCore $knowledgeBaseCore): ResourceMetadata
    {
        $response = $this->_create( $knowledgeBaseCore);
        $resource = new CreateKnowledgeBase202ResponseInstance(
                        $this->version,
                        $response->getContent()
                    );
    ...
    /**
     * Reads KnowledgeBasisInstance records from the API as a list.
     ...
     * @return KnowledgeBasisInstance[] Array of results
     */
    public function read(array $options = [], ?int $limit = null, $pageSize = null): array
    {
        $this->uri = '/ControlPlane/KnowledgeBases';
    ...
    /**
     * Streams KnowledgeBasisInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return KnowledgeBasisPage Page of KnowledgeBasisInstance
     */
    ...
    /**
     * Retrieve a single page of KnowledgeBasisInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return PageMetadata of KnowledgeBasisInstance
     */
     ...
     * @return KnowledgeBasisPage Page of KnowledgeBasisInstance
     */
    public function getPage(string $targetUrl): KnowledgeBasisPage
    {
    ...
    ): KnowledgeBasisContext
    {
        return new KnowledgeBasisContext(
            $this->version,
            $kbId
        );
    }
