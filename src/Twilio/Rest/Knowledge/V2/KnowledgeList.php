...
class KnowledgeList extends ListResource
     ...
     */
    private function _create(string $kbId, KnowledgeCore $knowledgeCore): Response
    {
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function create(string $kbId, KnowledgeCore $knowledgeCore): KnowledgeInstance
    {
        $response = $this->_create($kbId,  $knowledgeCore);
    ...
    /**
     * Create the KnowledgeInstance with Metadata
     *
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function createWithMetadata(string $kbId, KnowledgeCore $knowledgeCore): ResourceMetadata
    {
        $response = $this->_create($kbId,  $knowledgeCore);
     ...
     */
    public function read(string $kbId, array $options = [], ?int $limit = null, $pageSize = null): array
    {
     ...
     */
    public function readWithMetadata(string $kbId, array $options = [], ?int $limit = null, $pageSize = null): ArrayMetadata
    {
        $this->uri = '/KnowledgeBases/' . \rawurlencode($kbId)
        .'/Knowledge';
    ...
    /**
     * Streams KnowledgeInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
    ...
    /**
     * Retrieve a single page of KnowledgeInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return PageMetadata of KnowledgeInstance
     */
