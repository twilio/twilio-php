...
abstract class BindingOptions {
     ...
     */
    public static function create($tag = Values::NONE, $notificationProtocolVersion = Values::NONE, $credentialSid = Values::NONE, $endpoint = Values::NONE): CreateBindingOptions {
     ...
     */
    public static function read($startDate = Values::NONE, $endDate = Values::NONE, $identity = Values::NONE, $tag = Values::NONE): ReadBindingOptions {
...
class CreateBindingOptions extends Options {
     ...
     * @return $this Fluent Builder
     */
    public function setNotificationProtocolVersion($notificationProtocolVersion): self {
        $this->options['notificationProtocolVersion'] = $notificationProtocolVersion;
        return $this;
    }
     ...
     * @return $this Fluent Builder
     */
    public function setCredentialSid($credentialSid): self {
        $this->options['credentialSid'] = $credentialSid;
        return $this;
    }
