...
class CreateHostedNumberOrderOptions extends Options {
    ...
    */
    public function __toString(): string {
        ...
        return '[Twilio.Preview.Preview.CreateHostedNumberOrderOptions ' . $options . ']';
    }
}
...
class ReadHostedNumberOrderOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.ReadHostedNumberOrderOptions ' . $options . ']';
    }
}
...
class UpdateHostedNumberOrderOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.UpdateHostedNumberOrderOptions ' . $options . ']';
    }
}
