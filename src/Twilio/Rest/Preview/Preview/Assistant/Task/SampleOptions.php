...
namespace Twilio\Rest\Preview\Preview\Assistant\Task;
...
class CreateSampleOptions extends Options {
    ...
    */
    public function __toString(): string {
        ...
        return '[Twilio.Preview.Preview.CreateSampleOptions ' . $options . ']';
    }
}
...
class ReadSampleOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.ReadSampleOptions ' . $options . ']';
    }
}
...
class UpdateSampleOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.UpdateSampleOptions ' . $options . ']';
    }
}
