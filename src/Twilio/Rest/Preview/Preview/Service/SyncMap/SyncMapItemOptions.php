...
namespace Twilio\Rest\Preview\Preview\Service\SyncMap;
...
class DeleteSyncMapItemOptions extends Options {
    ...
    */
    public function __toString(): string {
        ...
        return '[Twilio.Preview.Preview.DeleteSyncMapItemOptions ' . $options . ']';
    }
}
...
class ReadSyncMapItemOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.ReadSyncMapItemOptions ' . $options . ']';
    }
}
...
class UpdateSyncMapItemOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.UpdateSyncMapItemOptions ' . $options . ']';
    }
}
