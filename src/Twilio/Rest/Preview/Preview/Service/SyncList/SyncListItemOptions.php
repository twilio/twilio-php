...
class DeleteSyncListItemOptions extends Options {
    ...
    */
    public function __toString(): string {
        ...
        return '[Twilio.Preview.Preview.DeleteSyncListItemOptions ' . $options . ']';
    }
}
...
class ReadSyncListItemOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.ReadSyncListItemOptions ' . $options . ']';
    }
}
...
class UpdateSyncListItemOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.UpdateSyncListItemOptions ' . $options . ']';
    }
}
