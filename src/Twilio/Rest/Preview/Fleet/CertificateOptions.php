...
namespace Twilio\Rest\Preview\Preview\Fleet;
...
class CreateCertificateOptions extends Options {
    ...
    */
    public function __toString(): string {
        ...
        return '[Twilio.Preview.Preview.CreateCertificateOptions ' . $options . ']';
    }
}
...
class ReadCertificateOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.ReadCertificateOptions ' . $options . ']';
    }
}
...
class UpdateCertificateOptions extends Options {
    ...
    */
    public function __toString(): string {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Preview.Preview.UpdateCertificateOptions ' . $options . ']';
    }
}
