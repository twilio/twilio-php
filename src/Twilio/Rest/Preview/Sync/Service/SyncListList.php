...
class SyncListList extends ListResource {
     ...
     */
    public function create($options = []): SyncListInstance {
     ...
     */
    public function page($pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): SyncListPage {
     ...
     * @return SyncListPage Page of SyncListInstance
     */
    public function getPage($targetUrl): SyncListPage {
     ...
     */
    public function getContext($sid): SyncListContext {
