...
namespace Twilio\Rest\Preview\Preview\Service;

use Twilio\Exceptions\TwilioException;
use Twilio\ListResource;
use Twilio\Version;
use Twilio\InstanceContext;
use Twilio\Rest\Preview\Preview\Service\SyncList\SyncListPermissionList;
use Twilio\Rest\Preview\Preview\Service\SyncList\SyncListItemList;


/**
 * @property SyncListPermissionList $syncListPermissions
 * @property SyncListItemList $syncListItems
 * @method \Twilio\Rest\Preview\Preview\Service\SyncList\SyncListPermissionContext syncListPermissions(string $identity)
 * @method \Twilio\Rest\Preview\Preview\Service\SyncList\SyncListItemContext syncListItems(string $index)
 */
...
class SyncListContext extends InstanceContext {
    ...
    public function __toString(): string {
        ...
        return '[Twilio.Preview.Preview.SyncListContext ' . \implode(' ', $context) . ']';
    }
}
