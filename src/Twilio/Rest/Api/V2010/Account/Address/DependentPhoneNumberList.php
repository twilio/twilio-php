...
class DependentPhoneNumberList extends ListResource {
    ...
    */
     ...
     *
     */
    public function getContext(): DependentPhoneNumberContext {
        return new DependentPhoneNumberContext($this->version, $this->solution['accountSid'], $this->solution['addressSid']);
    }
