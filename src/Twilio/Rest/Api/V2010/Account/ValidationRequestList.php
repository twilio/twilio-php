...
class ValidationRequestList extends ListResource {
    ...
    /**
     * Constructs a ValidationRequestContext
     *
     */
    public function getContext(): ValidationRequestContext {
        return new ValidationRequestContext($this->version, $this->solution['accountSid']);
    }
