...
class MachineToMachineList extends ListResource {
    ...
    */
    ...
    /**
     * Constructs a MachineToMachineContext
     *
     */
    public function getContext(): MachineToMachineContext {
        return new MachineToMachineContext($this->version, $this->solution['accountSid'], $this->solution['countryCode']);
    }
