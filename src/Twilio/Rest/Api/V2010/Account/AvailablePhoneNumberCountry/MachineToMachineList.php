...
class MachineToMachineList extends ListResource {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): MachineToMachinePage {
     ...
     * @return MachineToMachinePage Page of MachineToMachineInstance
     */
    public function getPage($targetUrl): MachineToMachinePage {
