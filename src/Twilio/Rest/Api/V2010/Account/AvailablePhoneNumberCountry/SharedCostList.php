...
class SharedCostList extends ListResource {
    ...
    */
    ...
    /**
     * Constructs a SharedCostContext
     *
     */
    public function getContext(): SharedCostContext {
        return new SharedCostContext($this->version, $this->solution['accountSid'], $this->solution['countryCode']);
    }
