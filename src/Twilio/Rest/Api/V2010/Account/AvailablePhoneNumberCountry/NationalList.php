...
class NationalList extends ListResource {
    ...
    */
    ...
    /**
     * Constructs a NationalContext
     *
     */
    public function getContext(): NationalContext {
        return new NationalContext($this->version, $this->solution['accountSid'], $this->solution['countryCode']);
    }
