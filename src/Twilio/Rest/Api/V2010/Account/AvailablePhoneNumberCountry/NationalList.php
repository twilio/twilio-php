...
class NationalList extends ListResource {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): NationalPage {
     ...
     * @return NationalPage Page of NationalInstance
     */
    public function getPage($targetUrl): NationalPage {
