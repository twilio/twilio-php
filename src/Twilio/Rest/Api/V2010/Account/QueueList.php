...
class QueueList extends ListResource {
     ...
     */
    public function page($pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): QueuePage {
     ...
     * @return QueuePage Page of QueueInstance
     */
    public function getPage($targetUrl): QueuePage {
     ...
     */
    public function create($friendlyName, $options = []): QueueInstance {
     ...
     */
    public function getContext($sid): QueueContext {
