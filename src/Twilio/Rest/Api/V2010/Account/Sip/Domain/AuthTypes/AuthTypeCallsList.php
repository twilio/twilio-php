...
class AuthTypeCallsList extends ListResource {
    ...
    /**
     * Constructs a AuthTypeCallsContext
     *
     */
    public function getContext(): AuthTypeCallsContext {
        return new AuthTypeCallsContext($this->version, $this->solution['accountSid'], $this->solution['domainSid']);
    }
