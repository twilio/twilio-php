...
class AuthTypesList extends ListResource {
    ...
    /**
     * Constructs a AuthTypesContext
     *
     */
    public function getContext(): AuthTypesContext {
        return new AuthTypesContext($this->version, $this->solution['accountSid'], $this->solution['domainSid']);
    }
