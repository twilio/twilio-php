...
class AuthTypeRegistrationsList extends ListResource {
    ...
    /**
     * Constructs a AuthTypeRegistrationsContext
     *
     */
    public function getContext(): AuthTypeRegistrationsContext {
        return new AuthTypeRegistrationsContext($this->version, $this->solution['accountSid'], $this->solution['domainSid']);
    }
