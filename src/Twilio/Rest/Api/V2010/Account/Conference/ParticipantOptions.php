...
abstract class ParticipantOptions {
     ...
     * @param string $recordingTrack The track to record
...
class CreateParticipantOptions extends Options {
    ...
    /**
     * The track to record. Can be: `inbound`, `outbound`, or `both`. The default is `both`. `inbound` only records the audio received by Twilio, `outbound` only records audio sent from Twilio, and `both` mixes the inbound and outbound audio.
     *
     * @param string $recordingTrack The track to record
     * @return $this Fluent Builder
     */
