...
class SigningKeyContext extends InstanceContext
    ...
    /**
     * Delete the SigningKeyInstance with Metadata
     *
    ...
    /**
     * Fetch the SigningKeyInstance with Metadata
     *
    ...
    {
        $response = $this->_fetch();
        $resource = new SigningKeyInstance(
                        $this->version,
                        $response->getContent(),
                        $this->solution['accountSid'],
                        $this->solution['sid']
    ...
    /**
     * Update the SigningKeyInstance with Metadata
     *
     * @param array|Options $options Optional Arguments
