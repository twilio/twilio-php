...
class UserDefinedMessageList extends ListResource {
    ...
    /**
     * Constructs a UserDefinedMessageContext
     *
     */
    public function getContext(): UserDefinedMessageContext {
        return new UserDefinedMessageContext($this->version, $this->solution['accountSid'], $this->solution['callSid']);
    }
