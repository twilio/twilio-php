...
class LocalList extends ListResource {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): LocalPage {
     ...
     * @return LocalPage Page of LocalInstance
     */
    public function getPage($targetUrl): LocalPage {
     ...
     */
    public function create($phoneNumber, $options = []): LocalInstance {
        $options = new Values($options);
