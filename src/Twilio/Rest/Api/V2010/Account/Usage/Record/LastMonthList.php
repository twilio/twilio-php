...
class LastMonthList extends ListResource {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): LastMonthPage {
     ...
     * @return LastMonthPage Page of LastMonthInstance
     */
    public function getPage($targetUrl): LastMonthPage {
