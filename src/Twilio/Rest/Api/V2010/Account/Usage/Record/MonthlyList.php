...
class MonthlyList extends ListResource {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): MonthlyPage {
     ...
     * @return MonthlyPage Page of MonthlyInstance
     */
    public function getPage($targetUrl): MonthlyPage {
