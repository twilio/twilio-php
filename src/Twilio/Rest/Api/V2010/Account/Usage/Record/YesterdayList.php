...
class YesterdayList extends ListResource {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): YesterdayPage {
     ...
     * @return YesterdayPage Page of YesterdayInstance
     */
    public function getPage($targetUrl): YesterdayPage {
