...
class TriggerList extends ListResource {
     ...
     */
    public function create($callbackUrl, $triggerValue, $usageCategory, $options = []): TriggerInstance {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): TriggerPage {
        $options = new Values($options);
        $params = Values::of([
            'Recurring' => $options['recurring'],
            'TriggerBy' => $options['triggerBy'],
     ...
     * @return TriggerPage Page of TriggerInstance
     */
    public function getPage($targetUrl): TriggerPage {
     ...
     */
    public function getContext($sid): TriggerContext {
