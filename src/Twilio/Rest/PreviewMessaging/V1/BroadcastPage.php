...
class BroadcastPage extends Page
     ...
     * @return BroadcastInstance \Twilio\Rest\PreviewMessaging\V1\BroadcastInstance
     */
    public function buildInstance(array $payload): BroadcastInstance
    {
        return new BroadcastInstance($this->version, $payload);
    }
    ...
    {
        return '[Twilio.PreviewMessaging.V1.BroadcastPage]';
    }
}
