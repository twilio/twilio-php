...
class MessagePage extends Page
     ...
     * @return MessageInstance \Twilio\Rest\PreviewMessaging\V1\MessageInstance
     */
    public function buildInstance(array $payload): MessageInstance
    {
        return new MessageInstance($this->version, $payload);
    }
    ...
    {
        return '[Twilio.PreviewMessaging.V1.MessagePage]';
    }
}
