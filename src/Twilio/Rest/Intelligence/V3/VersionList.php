...
class VersionList extends ListResource
     ...
     */
    public function read(string $id, array $options = [], ?int $limit = null, $pageSize = null): array
    {
     ...
     */
    public function readWithMetadata(string $id, array $options = [], ?int $limit = null, $pageSize = null): ArrayMetadata
    {
        $this->uri = '/ControlPlane/Operators/' . \rawurlencode($id)
        .'/Versions';
    ...
    /**
     * Streams VersionInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
    ...
    /**
     * Retrieve a single page of VersionInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return PageMetadata of VersionInstance
     */
