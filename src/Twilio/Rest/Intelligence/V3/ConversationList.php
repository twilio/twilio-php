    ...
    ): Response
    {
        ...
        $params = Values::of([
            ...
            'pageToken' =>
                $options['pageToken'],
            'createdAtBefore' =>
                Serialize::iso8601DateTime($options['createdAtBefore']),
            'createdAtAfter' =>
                Serialize::iso8601DateTime($options['createdAtAfter']),
            'status' =>
                $options['status'],
            'channelId' =>
                $options['channelId'],
            'channels' =>
                Serialize::map($options['channels'], function ($e) { return $e; }),
            'conversationConfigurationId' =>
                $options['conversationConfigurationId'],
            'intelligenceConfigurationIds' =>
                Serialize::map($options['intelligenceConfigurationIds'], function ($e) { return $e; }),
            'operatorIds' =>
                Serialize::map($options['operatorIds'], function ($e) { return $e; }),
