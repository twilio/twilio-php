...
class OperatorList extends ListResource
     ...
     *
     * @param LanguageOperator $languageOperator Create Language Operator request
     
     * @return Response Created Response
     * @throws TwilioException When an HTTP error occurs.
     */
    private function _create(LanguageOperator $languageOperator): Response
    {
    ...
    /**
     * Create the CreateOperator201ResponseInstance
     *
     * @param LanguageOperator $languageOperator Create Language Operator request
     
     * @return CreateOperator201ResponseInstance Created CreateOperator201ResponseInstance
     * @throws TwilioException When an HTTP error occurs.
     */
    public function create(LanguageOperator $languageOperator): CreateOperator201ResponseInstance
    {
        $response = $this->_create( $languageOperator);
    ...
    /**
     * Create the CreateOperator201ResponseInstance with Metadata
     *
     * @param LanguageOperator $languageOperator Create Language Operator request
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function createWithMetadata(LanguageOperator $languageOperator): ResourceMetadata
    {
        $response = $this->_create( $languageOperator);
    ...
    {
        $this->uri = '/ControlPlane/Operators';
    ...
    /**
     * Streams OperatorInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
    ...
    /**
     * Retrieve a single page of OperatorInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return PageMetadata of OperatorInstance
     */
