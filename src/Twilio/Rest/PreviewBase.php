...
/**
 * @property \Twilio\Rest\Preview\DeployedDevices $deployed_devices
 * @property \Twilio\Rest\Preview\HostedNumbers $hosted_numbers
...
class PreviewBase extends Domain {
    protected $_deployed_devices;
    protected $_hosted_numbers;
    protected $_sync;
    ...
    */
    ...
    /**
     * @return DeployedDevices Version deployed_devices of accounts
    */
    protected function getDeployedDevices(): DeployedDevices {
        if (!$this->_deployed_devices) {
            $this->_deployed_devices = new DeployedDevices($this);
        }
        return $this->_deployed_devices;
    }
    /**
     * @return HostedNumbers Version hosted_numbers of accounts
    */
    protected function getHostedNumbers(): HostedNumbers {
        if (!$this->_hosted_numbers) {
            $this->_hosted_numbers = new HostedNumbers($this);
        }
        return $this->_hosted_numbers;
    }
    /**
     * @return Sync Version sync of accounts
    */
    ...
    /**
     * @return Marketplace Version marketplace of accounts
    */
    ...
    /**
     * @return Understand Version understand of accounts
    */
    ...
    /**
     * @return Wireless Version wireless of accounts
    */
