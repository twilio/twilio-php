...
class ChannelsSenderList extends ListResource
    {
    /**
     * Construct the ChannelsSenderList
     *
    ...
    /**
     * Reads ChannelsSenderInstance records from the API as a list.
     ...
     * @return ChannelsSenderInstance[] Array of results
     */
    ...
    /**
     * Streams ChannelsSenderInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return ChannelsSenderPage Page of ChannelsSenderInstance
     */
    ...
    ): ChannelsSenderPage
    {
        ...
        return new ChannelsSenderPage($this->version, $response, $this->solution);
    }

    /**
     * Retrieve a single page of ChannelsSenderInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return PageMetadata of ChannelsSenderInstance
     */
    ...
    ): PageMetadata
    {
        ...
        $resource =  new ChannelsSenderPage($this->version, $response, $this->solution);
     ...
     * @return ChannelsSenderPage Page of ChannelsSenderInstance
     */
    public function getPage(string $targetUrl): ChannelsSenderPage
    {
    ...
    {
        return new ChannelsSenderContext(
            $this->version,
            $sid
        );
    }
