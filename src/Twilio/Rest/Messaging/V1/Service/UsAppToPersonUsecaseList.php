...
class UsAppToPersonUsecaseList extends ListResource {
    ...
    /**
     * Constructs a UsAppToPersonUsecaseContext
     *
     */
    public function getContext(): UsAppToPersonUsecaseContext {
        return new UsAppToPersonUsecaseContext($this->version, $this->solution['messagingServiceSid']);
    }
