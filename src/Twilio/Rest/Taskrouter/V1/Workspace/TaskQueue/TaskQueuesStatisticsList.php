...
class TaskQueuesStatisticsList extends ListResource {
    ...
    */
    ...
    /**
     * Constructs a TaskQueuesStatisticsContext
     *
     */
    public function getContext(): TaskQueuesStatisticsContext {
        return new TaskQueuesStatisticsContext($this->version, $this->solution['workspaceSid']);
    }
