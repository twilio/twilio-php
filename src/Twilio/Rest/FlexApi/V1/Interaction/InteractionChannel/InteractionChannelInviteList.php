...
class InteractionChannelInviteList extends ListResource {
    ...
    */
    ...
    /**
     * Constructs a InteractionChannelInviteContext
     *
     */
    public function getContext(): InteractionChannelInviteContext {
        return new InteractionChannelInviteContext($this->version, $this->solution['interactionSid'], $this->solution['channelSid']);
    }
