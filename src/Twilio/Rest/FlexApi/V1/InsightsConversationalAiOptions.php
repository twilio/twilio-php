...
abstract class InsightsConversationalAiOptions
{
    /**
     * @param int $maxRows Maximum number of rows to return
     * @param string $reportId The type of report required to fetch.Like gauge,channel-metrics,queue-metrics
     * @param string $granularity The time period for which report is needed
     * @param \DateTime $includeDate A reference date that should be included in the returned period
     * @return FetchInsightsConversationalAiOptions Options builder
     */
    ...
    ): FetchInsightsConversationalAiOptions
    {
        return new FetchInsightsConversationalAiOptions(
            $maxRows,
            $reportId,
            $granularity,
            $includeDate
...
class FetchInsightsConversationalAiOptions extends Options
    {
    /**
     * @param int $maxRows Maximum number of rows to return
     * @param string $reportId The type of report required to fetch.Like gauge,channel-metrics,queue-metrics
    ...
    public function __toString(): string
    {
        ...
        return '[Twilio.FlexApi.V1.FetchInsightsConversationalAiOptions ' . $options . ']';
    }
}
