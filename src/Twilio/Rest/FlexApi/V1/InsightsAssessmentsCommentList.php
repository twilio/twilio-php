...
class InsightsAssessmentsCommentList extends ListResource {
     ...
     * @param string $userEmail The user email id.
     * @param string $agentId Agent Id.
     * @param string $offset Offset.
     * @param array|Options $options Optional Arguments
     * @return InsightsAssessmentsCommentInstance Created
    ...
    /**
     * Streams InsightsAssessmentsCommentInstance records from the API as a
     * generator stream.
    ...
    /**
     * Retrieve a single page of InsightsAssessmentsCommentInstance records from
     * the API.
     ...
     * @return InsightsAssessmentsCommentPage Page of
     *                                        InsightsAssessmentsCommentInstance
     */
    public function page(array $options = [], $pageSize = Values::NONE, string $pageToken = Values::NONE, $pageNumber = Values::NONE): InsightsAssessmentsCommentPage {
        $options = new Values($options);
    ...
    /**
     * Retrieve a specific page of InsightsAssessmentsCommentInstance records from
     * the API.
     * Request is executed immediately
     *
