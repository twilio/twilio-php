...
class PublicKeyList extends ListResource {
     ...
     */
    public function page($pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): PublicKeyPage {
     ...
     * @return PublicKeyPage Page of PublicKeyInstance
     */
    public function getPage($targetUrl): PublicKeyPage {
     ...
     */
    public function create($publicKey, $options = []): PublicKeyInstance {
     ...
     */
    public function getContext($sid): PublicKeyContext {
