...
class PortingAllPortInList extends ListResource
    {
    /**
     * Construct the PortingAllPortInList
     *
    ...
    /**
     * Reads PortingAllPortInInstance records from the API as a list.
     ...
     * @return PortingAllPortInInstance[] Array of results
     */
    ...
    /**
     * Streams PortingAllPortInInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return PortingAllPortInPage Page of PortingAllPortInInstance
     */
    ...
    ): PortingAllPortInPage
    {
        ...
        return new PortingAllPortInPage($this->version, $response, $this->solution);
    }

    /**
     * Retrieve a single page of PortingAllPortInInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return PageMetadata of PortingAllPortInInstance
     */
    ...
    ): PageMetadata
    {
        ...
        $resource =  new PortingAllPortInPage($this->version, $response, $this->solution);
     ...
     * @return PortingAllPortInPage Page of PortingAllPortInInstance
     */
    public function getPage(string $targetUrl): PortingAllPortInPage
    {
