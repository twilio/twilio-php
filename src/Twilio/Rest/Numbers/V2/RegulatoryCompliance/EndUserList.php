...
class EndUserList extends ListResource {
     ...
     */
    public function create($friendlyName, $type, $options = []): EndUserInstance {
     ...
     */
    public function page($pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): EndUserPage {
     ...
     * @return EndUserPage Page of EndUserInstance
     */
    public function getPage($targetUrl): EndUserPage {
     ...
     */
    public function getContext($sid): EndUserContext {
