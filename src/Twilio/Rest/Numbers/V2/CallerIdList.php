...
class CallerIdList extends ListResource
    {
    /**
     * Construct the CallerIdList
     *
    ...
    /**
     * Reads CallerIdInstance records from the API as a list.
     ...
     * @return CallerIdInstance[] Array of results
     */
    ...
    /**
     * Streams CallerIdInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return CallerIdPage Page of CallerIdInstance
     */
    ...
    ): CallerIdPage
    {
        ...
        return new CallerIdPage($this->version, $response, $this->solution);
    }

    /**
     * Retrieve a single page of CallerIdInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return PageMetadata of CallerIdInstance
     */
    ...
    ): PageMetadata
    {
        ...
        $resource =  new CallerIdPage($this->version, $response, $this->solution);
     ...
     * @return CallerIdPage Page of CallerIdInstance
     */
    public function getPage(string $targetUrl): CallerIdPage
    {
