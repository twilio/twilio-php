...
class RoomRecordingList extends ListResource {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): RoomRecordingPage {
     ...
     * @return RoomRecordingPage Page of RoomRecordingInstance
     */
    public function getPage($targetUrl): RoomRecordingPage {
     ...
     */
    public function getContext($sid): RoomRecordingContext {
