...
class SubscribeRulesList extends ListResource {
    ...
    /**
     * Constructs a SubscribeRulesContext
     *
     */
    public function getContext(): SubscribeRulesContext {
        return new SubscribeRulesContext($this->version, $this->solution['roomSid'], $this->solution['participantSid']);
    }
