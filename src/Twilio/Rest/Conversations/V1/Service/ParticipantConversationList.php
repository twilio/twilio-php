...
class ParticipantConversationList extends ListResource {
    ...
    */
    ...
    /**
     * Constructs a ParticipantConversationContext
     *
     */
    public function getContext(): ParticipantConversationContext {
        return new ParticipantConversationContext($this->version, $this->solution['chatServiceSid']);
    }
