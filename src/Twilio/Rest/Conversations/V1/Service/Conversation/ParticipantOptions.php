...
abstract class ParticipantOptions {
    ...
    */
    public static function update(string  $xTwilioWebhookEnabled=Values::NONE,\DateTime  $dateCreated=Values::NONE,\DateTime  $dateUpdated=Values::NONE,string  $identity=Values::NONE,string  $attributes=Values::NONE,string  $roleSid=Values::NONE,string  $messagingBindingProxyAddress=Values::NONE,string  $messagingBindingProjectedAddress=Values::NONE,int  $lastReadMessageIndex=Values::NONE,string  $lastReadTimestamp=Values::NONE): UpdateParticipantOptions {
        return new UpdateParticipantOptions($xTwilioWebhookEnabled,$dateCreated,$dateUpdated,$identity,$attributes,$roleSid,$messagingBindingProxyAddress,$messagingBindingProjectedAddress,$lastReadMessageIndex,$lastReadTimestamp);
    }
...
class UpdateParticipantOptions extends Options {
    ...
    * @param string $lastReadTimestamp Timestamp of last “read” message in the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource) for the Participant.
    */
    public function __construct(string  $xTwilioWebhookEnabled=Values::NONE,\DateTime  $dateCreated=Values::NONE,\DateTime  $dateUpdated=Values::NONE,string  $identity=Values::NONE,string  $attributes=Values::NONE,string  $roleSid=Values::NONE,string  $messagingBindingProxyAddress=Values::NONE,string  $messagingBindingProjectedAddress=Values::NONE,int  $lastReadMessageIndex=Values::NONE,string  $lastReadTimestamp=Values::NONE) {
        $this->options['xTwilioWebhookEnabled'] = $xTwilioWebhookEnabled;
        $this->options['dateCreated'] = $dateCreated;
        $this->options['dateUpdated'] = $dateUpdated;
        $this->options['identity'] = $identity;
