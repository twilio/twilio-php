...
class CommunicationList extends ListResource
    {
    /**
     * Construct the CommunicationList
     *
     ...
     * @param ?CreateCommunicationInConversationRequest $createCommunicationInConversationRequest
    ...
    private function _create(string $conversationSid, ?CreateCommunicationInConversationRequest $createCommunicationInConversationRequest = null): Response
    {
        ...
        $data = $createCommunicationInConversationRequest ? $createCommunicationInConversationRequest->toArray() : [];
        return $this->version->handleRequest('POST', $uri, [], $data, $headers, "create");
    }

    /**
     * Create the ListCommunicationByConversation200ResponseCommunicationsInstance
     *
    ...
    /**
     * Create the ListCommunicationByConversation200ResponseCommunicationsInstance with Metadata
     *
    ...
    /**
     * Reads CommunicationInstance records from the API as a list.
    ...
    /**
     * Streams CommunicationInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return CommunicationPage Page of CommunicationInstance
     */
    ...
    /**
     * Retrieve a single page of CommunicationInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return PageMetadata of CommunicationInstance
     */
     ...
     * @return CommunicationPage Page of CommunicationInstance
     */
    public function getPage(string $targetUrl): CommunicationPage
    {
