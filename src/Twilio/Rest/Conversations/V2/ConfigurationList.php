...
class ConfigurationList extends ListResource
     ...
     *
     * @param ?CreateConfigurationRequest $createConfigurationRequest The configuration to create
     * @param array|Options $options Optional Arguments
     * @return Response Created Response
     * @throws TwilioException When an HTTP error occurs.
     */
    private function _create(?CreateConfigurationRequest $createConfigurationRequest = null, array $options = []): Response
    {
        ...
        $data = $createConfigurationRequest ? $createConfigurationRequest->toArray() : [];
        return $this->version->handleRequest('POST', $uri, [], $data, $headers, "create");
    }

    /**
     * Create the CreateConfiguration202ResponseInstance
     *
     * @param ?CreateConfigurationRequest $createConfigurationRequest The configuration to create
     * @param array|Options $options Optional Arguments
     * @return CreateConfiguration202ResponseInstance Created CreateConfiguration202ResponseInstance
     * @throws TwilioException When an HTTP error occurs.
     */
    public function create(?CreateConfigurationRequest $createConfigurationRequest = null, array $options = []): CreateConfiguration202ResponseInstance
    {
        $response = $this->_create($createConfigurationRequest, $options);
    ...
    /**
     * Create the CreateConfiguration202ResponseInstance with Metadata
     *
     * @param ?CreateConfigurationRequest $createConfigurationRequest The configuration to create
     * @param array|Options $options Optional Arguments
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function createWithMetadata(?CreateConfigurationRequest $createConfigurationRequest = null, array $options = []): ResourceMetadata
    {
        $response = $this->_create($createConfigurationRequest, $options);
