...
class TraitList extends ListResource
    {
    /**
     * Construct the TraitList
     *
    ...
    /**
     * Reads TraitInstance records from the API as a list.
     ...
     * @return TraitInstance[] Array of results
     */
    ...
    /**
     * Streams TraitInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return TraitPage Page of TraitInstance
     */
    ...
    /**
     * Retrieve a single page of TraitInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return PageMetadata of TraitInstance
     */
     ...
     * @return TraitPage Page of TraitInstance
     */
    public function getPage(string $targetUrl): TraitPage
    {
