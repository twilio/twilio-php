...
class BulkPage extends TokenPaginationPage
    {
    /**
     ...
     * @return BulkInstance \Twilio\Rest\Memory\V1\BulkInstance
     */
    public function buildInstance(array $payload): BulkInstance
    {
        return new BulkInstance($this->version, $payload);
    }
    ...
    {
        return '[Twilio.Memory.V1.BulkPage]';
    }
}
