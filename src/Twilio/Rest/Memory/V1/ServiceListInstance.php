 ...
 */
class ServiceListInstance extends InstanceResource
{
    /**
     * Initialize the ServiceListInstance
     *
    ...
    public function __construct(Version $version, array $payload, ?string $storeId = null)
    {
        ...
        $this->properties = [
            'stores' => Values::array_get($payload, 'stores'),
    ...
    public function __toString(): string
    {
        ...
        return '[Twilio.Memory.V1.ServiceListInstance ' . \implode(' ', $context) . ']';
    }
}
