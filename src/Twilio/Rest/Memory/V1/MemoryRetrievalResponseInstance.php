 ...
 */
class MemoryRetrievalResponseInstance extends InstanceResource
{
    /**
     * Initialize the MemoryRetrievalResponseInstance
     *
    ...
    public function __construct(Version $version, array $payload, ?string $storeId = null, ?string $profileId = null)
    {
        ...
        $this->properties = [
            'observations' => Values::array_get($payload, 'observations'),
            'summaries' => Values::array_get($payload, 'summaries'),
            'communications' => Values::array_get($payload, 'communications'),
    ...
    {
        return '[Twilio.Memory.V1.MemoryRetrievalResponseInstance]';
    }
}
