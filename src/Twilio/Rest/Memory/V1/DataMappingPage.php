...
class DataMappingPage extends TokenPaginationPage
    {
    /**
     ...
     * @return DataMappingInstance \Twilio\Rest\Memory\V1\DataMappingInstance
     */
    public function buildInstance(array $payload): DataMappingInstance
    {
        return new DataMappingInstance($this->version, $payload);
    }
