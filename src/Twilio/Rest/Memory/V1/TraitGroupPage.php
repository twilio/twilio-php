...
class TraitGroupPage extends TokenPaginationPage
    {
    /**
     ...
     * @return TraitGroupInstance \Twilio\Rest\Memory\V1\TraitGroupInstance
     */
    public function buildInstance(array $payload): TraitGroupInstance
    {
        return new TraitGroupInstance($this->version, $payload);
    }
