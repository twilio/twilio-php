...
class RecallPage extends TokenPaginationPage
    {
    /**
     ...
     * @return RecallInstance \Twilio\Rest\Memory\V1\RecallInstance
     */
    public function buildInstance(array $payload): RecallInstance
    {
        return new RecallInstance($this->version, $payload);
    }
    ...
    {
        return '[Twilio.Memory.V1.RecallPage]';
    }
}
