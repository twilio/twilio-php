...
class LookupPage extends TokenPaginationPage
    {
    /**
     ...
     * @return LookupInstance \Twilio\Rest\Memory\V1\LookupInstance
     */
    public function buildInstance(array $payload): LookupInstance
    {
        return new LookupInstance($this->version, $payload);
    }
    ...
    {
        return '[Twilio.Memory.V1.LookupPage]';
    }
}
