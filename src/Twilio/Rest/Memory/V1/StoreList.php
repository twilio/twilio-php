...
class StoreList extends ListResource
    {
    /**
     * Construct the StoreList
     *
     ...
     */
    private function _create(ServiceRequest $serviceRequest): Response
    {
    ...
    /**
     * Create the CreateStore202ResponseInstance
     *
     * @param ServiceRequest $serviceRequest
     
     * @return CreateStore202ResponseInstance Created CreateStore202ResponseInstance
     * @throws TwilioException When an HTTP error occurs.
     */
    public function create(ServiceRequest $serviceRequest): CreateStore202ResponseInstance
    {
        $response = $this->_create( $serviceRequest);
        return new CreateStore202ResponseInstance(
            $this->version,
            $response->getContent()
        );
    ...
    /**
     * Create the CreateStore202ResponseInstance with Metadata
     *
     * @param ServiceRequest $serviceRequest
     ...
     * @throws TwilioException When an HTTP error occurs.
     */
    public function createWithMetadata(ServiceRequest $serviceRequest): ResourceMetadata
    {
        $response = $this->_create( $serviceRequest);
        $resource = new CreateStore202ResponseInstance(
                        $this->version,
                        $response->getContent()
                    );
    ...
    /**
     * Reads StoreInstance records from the API as a list.
     ...
     * @return StoreInstance[] Array of results
     */
    public function read(array $options = [], ?int $limit = null, $pageSize = null): array
    {
        $this->uri = '/ControlPlane/Stores';
    ...
    /**
     * Streams StoreInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return StorePage Page of StoreInstance
     */
    ...
    /**
     * Retrieve a single page of StoreInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * 
     * @return PageMetadata of StoreInstance
     */
     ...
     * @return StorePage Page of StoreInstance
     */
    public function getPage(string $targetUrl): StorePage
    {
