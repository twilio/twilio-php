...
/**
 * @property string[] $identifierConfigs
 * @property string[] $matchingRules
 * @property int $version
 */
class IdentityResolutionSettingsInstance extends InstanceResource
{
    /**
     * Initialize the IdentityResolutionSettingsInstance
     *
    ...
    public function __construct(Version $version, array $payload, ?string $storeId = null)
    {
        ...
        $this->properties = [
            'identifierConfigs' => Values::array_get($payload, 'identifierConfigs'),
            'matchingRules' => Values::array_get($payload, 'matchingRules'),
    ...
    {
        return '[Twilio.Memory.V1.IdentityResolutionSettingsInstance]';
    }
}
