...
abstract class TraitOptions
{
     ...
     * @return ReadTraitOptions Options builder
     */
...
class ReadTraitOptions extends Options
    {
    /**
     * @param int $pageSize The maximum number of items to return per page, maximum of 1000.
     * @param string $pageToken The token for the page of results to retrieve.
    ...
    public function __toString(): string
    {
        ...
        return '[Twilio.Memory.V1.ReadTraitOptions ' . $options . ']';
    }
}
