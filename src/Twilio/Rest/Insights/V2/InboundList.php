...
class InboundList extends ListResource
    {
    /**
     * Construct the InboundList
     *
    ...
    /**
     * Reads InboundInstance records from the API as a list.
     ...
     * @return InboundInstance[] Array of results
     */
    ...
    /**
     * Streams InboundInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return InboundPage Page of InboundInstance
     */
    ...
    ): InboundPage
    {
        ...
        return new InboundPage($this->version, $response, $this->solution);
    }

    /**
     * Retrieve a single page of InboundInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return PageMetadata of InboundInstance
     */
    ...
    ): PageMetadata
    {
        ...
        $resource =  new InboundPage($this->version, $response, $this->solution);
     ...
     * @return InboundPage Page of InboundInstance
     */
    public function getPage(string $targetUrl): InboundPage
    {
