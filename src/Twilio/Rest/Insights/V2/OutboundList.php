...
class OutboundList extends ListResource
    {
    /**
     * Construct the OutboundList
     *
    ...
    public function __construct(
        ...
        $this->uri = '/Voice/Reports/PhoneNumbers/Outbound/' . \rawurlencode($reportId)
        .'';
    }

    /**
     * Reads OutboundInstance records from the API as a list.
     ...
     * @return OutboundInstance[] Array of results
     */
    ...
    /**
     * Streams OutboundInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
     ...
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return OutboundPage Page of OutboundInstance
     */
    ...
    ): OutboundPage
    {
        ...
        return new OutboundPage($this->version, $response, $this->solution);
    }

    /**
     * Retrieve a single page of OutboundInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return PageMetadata of OutboundInstance
     */
    ...
    ): PageMetadata
    {
        ...
        $resource =  new OutboundPage($this->version, $response, $this->solution);
     ...
     * @return OutboundPage Page of OutboundInstance
     */
    public function getPage(string $targetUrl): OutboundPage
    {
