 ...
 */
class CustomFieldMappingsListInstance extends InstanceResource
{
    /**
     * Initialize the CustomFieldMappingsListInstance
     *
    ...
    public function __construct(Version $version, array $payload)
    {
        ...
        $this->properties = [
            'mappings' => Values::array_get($payload, 'mappings'),
        ];
    ...
    {
        return '[Twilio.Insights.V3.CustomFieldMappingsListInstance]';
    }
}
