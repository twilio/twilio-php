...
class CapacityPage extends TokenPaginationPage
    {
    /**
     ...
     * @return CapacityInstance \Twilio\Rest\Insights\V3\CapacityInstance
     */
    public function buildInstance(array $payload): CapacityInstance
    {
        return new CapacityInstance($this->version, $payload);
    }
    ...
    {
        return '[Twilio.Insights.V3.CapacityPage]';
    }
}
