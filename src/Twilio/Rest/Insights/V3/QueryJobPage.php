...
class QueryJobPage extends TokenPaginationPage
    {
    /**
     ...
     * @return QueryJobStatusResponseInstance \Twilio\Rest\Insights\V3\QueryJobStatusResponseInstance
     */
    public function buildInstance(array $payload): QueryJobStatusResponseInstance
    {
        return new QueryJobStatusResponseInstance($this->version, $payload);
    }
