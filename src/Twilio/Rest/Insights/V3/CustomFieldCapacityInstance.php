 ...
 */
class CustomFieldCapacityInstance extends InstanceResource
{
    /**
     * Initialize the CustomFieldCapacityInstance
     *
    ...
    public function __construct(Version $version, array $payload)
    {
        ...
        $this->properties = [
            'measure' => Values::array_get($payload, 'measure'),
        ];
    ...
    {
        return '[Twilio.Insights.V3.CustomFieldCapacityInstance]';
    }
}
