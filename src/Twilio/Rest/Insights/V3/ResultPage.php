...
class ResultPage extends TokenPaginationPage
    {
    /**
     ...
     * @return ResultInstance \Twilio\Rest\Insights\V3\ResultInstance
     */
    public function buildInstance(array $payload): ResultInstance
    {
        return new ResultInstance($this->version, $payload);
    }
    ...
    {
        return '[Twilio.Insights.V3.ResultPage]';
    }
}
