...
class Client extends BaseClient {
    ...
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Address resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Application resource to fetch.
    */
    ...
    /**
     * @param The SID of the Connect App to fetch.
    */
    ...
    /**
     * @param The [ISO-3166-1](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code of the country to fetch available phone number information about.
    */
    ...
    /**
     * @param The SID of the Call resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Conference resource to fetch
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the ConnectApp resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the IncomingPhoneNumber resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Key resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Message resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Notification resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the OutgoingCallerId resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Queue resource to fetch
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Recording resource to fetch.
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the ShortCode resource to fetch
    */
    ...
    */
    ...
    /**
     * @param The Twilio-provided string that uniquely identifies the Transcription resource to fetch.
    */
