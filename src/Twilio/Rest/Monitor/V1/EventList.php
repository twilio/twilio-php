...
class EventList extends ListResource {
     ...
     */
    public function page($options = [], $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE): EventPage {
     ...
     * @return EventPage Page of EventInstance
     */
    public function getPage($targetUrl): EventPage {
     ...
     */
    public function getContext($sid): EventContext {
