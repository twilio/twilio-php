...
abstract class PhoneNumberOptions {
    ...
    * @param  $addOnsData Data specific to the add-on you would like to invoke. The content and format of this value depends on the add-on. 
    * @return FetchPhoneNumberOptions Options builder
    */
    public static function fetch(string  $countryCode=Values::NONE,array  $type=Values::ARRAY_NONE,array  $addOns=Values::ARRAY_NONE,  $addOnsData=Values::NONE): FetchPhoneNumberOptions {
...
class FetchPhoneNumberOptions extends Options {
    ...
    * @param  $addOnsData Data specific to the add-on you would like to invoke. The content and format of this value depends on the add-on.
    */
    public function __construct(string  $countryCode=Values::NONE,array  $type=Values::ARRAY_NONE,array  $addOns=Values::ARRAY_NONE,  $addOnsData=Values::NONE) {
