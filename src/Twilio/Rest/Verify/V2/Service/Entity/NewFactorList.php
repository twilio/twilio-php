...
class NewFactorList extends ListResource {
    ...
    /**
     * Constructs a NewFactorContext
     *
     */
    public function getContext(): NewFactorContext {
        return new NewFactorContext($this->version, $this->solution['serviceSid'], $this->solution['identity']);
    }
