...
abstract class VerificationOptions {
    ...
    */
    public static function create(string  $customFriendlyName=Values::NONE,string  $customMessage=Values::NONE,string  $sendDigits=Values::NONE,string  $locale=Values::NONE,string  $customCode=Values::NONE,string  $amount=Values::NONE,string  $payee=Values::NONE,array  $rateLimits=Values::NONE,array  $channelConfiguration=Values::NONE,string  $appHash=Values::NONE,string  $templateSid=Values::NONE,string  $templateCustomSubstitutions=Values::NONE): CreateVerificationOptions {
...
class CreateVerificationOptions extends Options {
    ...
    * @param string $templateCustomSubstitutions A stringified JSON object in which the keys are the template&#39;s special variables and the values are the variables substitutions.
    */
    public function __construct(string  $customFriendlyName=Values::NONE,string  $customMessage=Values::NONE,string  $sendDigits=Values::NONE,string  $locale=Values::NONE,string  $customCode=Values::NONE,string  $amount=Values::NONE,string  $payee=Values::NONE,array  $rateLimits=Values::NONE,array  $channelConfiguration=Values::NONE,string  $appHash=Values::NONE,string  $templateSid=Values::NONE,string  $templateCustomSubstitutions=Values::NONE) {
