...
class VerificationCheckList extends ListResource {
    ...
    /**
     * Constructs a VerificationCheckContext
     *
     */
    public function getContext(): VerificationCheckContext {
        return new VerificationCheckContext($this->version, $this->solution['serviceSid']);
    }
