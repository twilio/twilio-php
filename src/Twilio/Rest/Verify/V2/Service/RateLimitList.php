...
class RateLimitList extends ListResource
    ...
    /**
     * Create the RateLimitInstance with Metadata
     *
     * @param string $uniqueName Provides a unique and addressable name to be assigned to this Rate Limit, assigned by the developer, to be optionally used in addition to SID. **This value should not contain PII.**
     * @param array|Options $options Optional Arguments
    ...
    /**
     * Streams RateLimitInstance records from the API as a generator stream and returns result with Metadata
     * This operation lazily loads records as efficiently as possible until the
     * limit
     * is reached.
     * The results are returned as a generator, so this operation is memory
    ...
    /**
     * Retrieve a single page of RateLimitInstance records with metadata
     * Request is executed immediately
     *
     * @param mixed $pageSize Number of records to return, defaults to 50
     * @param string $pageToken PageToken provided by the API
     * @param mixed $pageNumber Page Number, this value is simply for client state
     * @return PageMetadata of RateLimitInstance
     */
    ...
    ): PageMetadata
    {
        ...
        $resource =  new RateLimitPage($this->version, $response, $this->solution);
