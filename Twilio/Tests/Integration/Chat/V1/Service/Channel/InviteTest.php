    ...
    public function testReadEmptyResponse() {
        $this->holodeck->mock(new Response(
            ...
            '
            {
                "invites": [],
                "meta": {
                    "first_page_url": "https://ip-messaging.twilio.com/v1/Services/ISaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Channels/CHaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Invites?Page=0&PageSize=50",
                    "key": "invites",
                    "next_page_url": null,
                    "page": 0,
                    "page_size": 0,
