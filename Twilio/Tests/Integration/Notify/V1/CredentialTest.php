...
class CredentialTest extends HolodeckTestCase {
    ...
    public function testFetchRequest() {
        ...
        try {
            $this->twilio->notify->v1->credentials("CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testFetchResponse() {
        ...
        $actual = $this->twilio->notify->v1->credentials("CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
    ...
    public function testUpdateRequest() {
        ...
        try {
            $this->twilio->notify->v1->credentials("CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testUpdateResponse() {
        ...
        $actual = $this->twilio->notify->v1->credentials("CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update();
    ...
    public function testDeleteRequest() {
        ...
        try {
            $this->twilio->notify->v1->credentials("CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->delete();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testDeleteResponse() {
        ...
        $actual = $this->twilio->notify->v1->credentials("CRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->delete();
