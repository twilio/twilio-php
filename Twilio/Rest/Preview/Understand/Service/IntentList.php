...
class IntentList extends ListResource {
    ...
    public function __construct(Version $version, $serviceSid) {
        ...
        $this->uri = '/Services/' . rawurlencode($serviceSid) . '/Intents';
    }
    ...
    public function create($uniqueName, $options = array()) {
        ...
        return new IntentInstance($this->version, $payload, $this->solution['serviceSid']);
    }
    ...
    public function getContext($sid) {
        return new IntentContext($this->version, $this->solution['serviceSid'], $sid);
    }
