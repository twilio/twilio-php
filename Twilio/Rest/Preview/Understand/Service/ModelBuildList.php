...
class ModelBuildList extends ListResource {
    ...
    public function __construct(Version $version, $serviceSid) {
        ...
        $this->uri = '/Services/' . rawurlencode($serviceSid) . '/ModelBuilds';
    }
    ...
    public function create($options = array()) {
        ...
        return new ModelBuildInstance($this->version, $payload, $this->solution['serviceSid']);
    }
    ...
    public function getContext($sid) {
        return new ModelBuildContext($this->version, $this->solution['serviceSid'], $sid);
    }
