...
class RoomParticipantList extends ListResource {
    /**
     * Construct the RoomParticipantList
     * 
    ...
    /**
     * Reads RoomParticipantInstance records from the API as a list.
     ...
     *                        will attempt to read the limit with the most
     *                        efficient page size, i.e. min(limit, 1000)
     * @return RoomParticipantInstance[] Array of results
     */
     ...
     * @return \Twilio\Page Page of RoomParticipantInstance
     */
    public function page($options = array(), $pageSize = Values::NONE, $pageToken = Values::NONE, $pageNumber = Values::NONE) {
        ...
        return new RoomParticipantPage($this->version, $response, $this->solution);
    }
    ...
    public function getContext($sid) {
        return new RoomParticipantContext($this->version, $this->solution['roomSid'], $sid);
    }
