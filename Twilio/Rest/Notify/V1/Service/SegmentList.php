 ...
 */
class SegmentList extends ListResource {
    /**
     * Construct the SegmentList
     * 
    ...
    public function __construct(Version $version, $serviceSid) {
        ...
        $this->uri = '/Services/' . rawurlencode($serviceSid) . '/Segments';
    }
    ...
    /**
     * Reads SegmentInstance records from the API as a list.
     ...
     *                        will attempt to read the limit with the most
     *                        efficient page size, i.e. min(limit, 1000)
     * @return SegmentInstance[] Array of results
     */
